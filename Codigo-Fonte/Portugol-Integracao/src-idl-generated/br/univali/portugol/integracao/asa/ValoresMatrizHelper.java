...
/**
* br/univali/portugol/integracao/asa/ValoresMatrizHelper.java .
...
abstract public class ValoresMatrizHelper
{
  private static String  _id = "IDL:br/univali/portugol/integracao/asa/ValoresMatriz:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (br.univali.portugol.integracao.asa.ValoresVetorHelper.id (), "ValoresVetor", __typeCode);
      __typeCode = org.omg.CORBA.ORB.init ().create_sequence_tc (0, __typeCode);
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (br.univali.portugol.integracao.asa.ValoresMatrizHelper.id (), "ValoresMatriz", __typeCode);
    }
    return __typeCode;
  }
  ...
  public static org.omg.CORBA.Any[][] read (org.omg.CORBA.portable.InputStream istream)
  {
    ...
    for (int _o1 = 0;_o1 < value.length; ++_o1)
      value[_o1] = br.univali.portugol.integracao.asa.ValoresVetorHelper.read (istream);
    return value;
  }
  ...
  public static void write (org.omg.CORBA.portable.OutputStream ostream, org.omg.CORBA.Any[][] value)
  {
    ...
    for (int _i0 = 0;_i0 < value.length; ++_i0)
      br.univali.portugol.integracao.asa.ValoresVetorHelper.write (ostream, value[_i0]);
  }
