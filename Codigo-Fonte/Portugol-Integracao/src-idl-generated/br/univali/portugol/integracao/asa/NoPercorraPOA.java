...
/**
* br/univali/portugol/integracao/asa/NoPercorraPOA.java .
...
//==========================================================================================//
public abstract class NoPercorraPOA extends org.omg.PortableServer.Servant
 implements br.univali.portugol.integracao.asa.NoPercorraOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    _methods.put ("getExpessao", new java.lang.Integer (0));
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // br/univali/portugol/integracao/asa/NoPercorra/getExpessao
       {
         br.univali.portugol.integracao.asa.NoExpressao $result = null;
         $result = this.getExpessao ();
         out = $rh.createReply();
         br.univali.portugol.integracao.asa.NoExpressaoHelper.write (out, $result);
         break;
       }

       case 1:  // br/univali/portugol/integracao/asa/NoPercorra/getBlocos
       {
  ...
  public NoPercorra _this() 
  {
    return NoPercorraHelper.narrow(
    super._this_object());
  }

  public NoPercorra _this(org.omg.CORBA.ORB orb) 
  {
    return NoPercorraHelper.narrow(
