...
/**
* br/univali/portugol/integracao/asa/_NoEscolhaStub.java .
...
//==========================================================================================//
public class _NoEscolhaStub extends org.omg.CORBA.portable.ObjectImpl implements br.univali.portugol.integracao.asa.NoEscolha
{
  ...
  public br.univali.portugol.integracao.asa.NoCaso[] getCasos ()
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getCasos", true);
                $in = _invoke ($out);
                br.univali.portugol.integracao.asa.NoCaso $result[] = br.univali.portugol.integracao.asa.ListaNoCasoHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
