...
/**
* br/univali/portugol/integracao/asa/NoBlocoPOA.java .
...
//==========================================================================================//
public abstract class NoBlocoPOA extends org.omg.PortableServer.Servant
 implements br.univali.portugol.integracao.asa.NoBlocoOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  public NoBloco _this() 
  {
    return NoBlocoHelper.narrow(
    super._this_object());
  }

  public NoBloco _this(org.omg.CORBA.ORB orb) 
  {
    return NoBlocoHelper.narrow(
