...
/**
* br/univali/portugol/integracao/asa/NoEscolhaPOA.java .
...
//==========================================================================================//
public abstract class NoEscolhaPOA extends org.omg.PortableServer.Servant
 implements br.univali.portugol.integracao.asa.NoEscolhaOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("getCasos", new java.lang.Integer (1));
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // br/univali/portugol/integracao/asa/NoEscolha/getExpressao
       {
       ...
       case 1:  // br/univali/portugol/integracao/asa/NoEscolha/getCasos
       {
         br.univali.portugol.integracao.asa.NoCaso $result[] = null;
         $result = this.getCasos ();
         out = $rh.createReply();
         br.univali.portugol.integracao.asa.ListaNoCasoHelper.write (out, $result);
         break;
       }
  ...
  private static String[] __ids = {
    "IDL:br/univali/portugol/integracao/asa/NoEscolha:1.0", 
  ...
  public NoEscolha _this() 
  {
    return NoEscolhaHelper.narrow(
    super._this_object());
  }

  public NoEscolha _this(org.omg.CORBA.ORB orb) 
  {
    return NoEscolhaHelper.narrow(
