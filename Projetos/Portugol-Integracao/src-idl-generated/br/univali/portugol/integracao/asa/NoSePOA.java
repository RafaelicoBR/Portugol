...
/**
* br/univali/portugol/integracao/asa/NoSePOA.java .
...
//==========================================================================================//
public abstract class NoSePOA extends org.omg.PortableServer.Servant
 implements br.univali.portugol.integracao.asa.NoSeOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    _methods.put ("getCondicao", new java.lang.Integer (0));
    _methods.put ("getBlocosFalsos", new java.lang.Integer (1));
    _methods.put ("getBlocosVerdadeiros", new java.lang.Integer (2));
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // br/univali/portugol/integracao/asa/NoSe/getCondicao
       {
       ...
       case 1:  // br/univali/portugol/integracao/asa/NoSe/getBlocosFalsos
       {
         br.univali.portugol.integracao.asa.NoBloco $result[] = null;
         $result = this.getBlocosFalsos ();
         out = $rh.createReply();
         br.univali.portugol.integracao.asa.ListaNoBlocoHelper.write (out, $result);
         break;
       }

       case 2:  // br/univali/portugol/integracao/asa/NoSe/getBlocosVerdadeiros
       {
         br.univali.portugol.integracao.asa.NoBloco $result[] = null;
         $result = this.getBlocosVerdadeiros ();
         out = $rh.createReply();
         br.univali.portugol.integracao.asa.ListaNoBlocoHelper.write (out, $result);
         break;
       }
  ...
  public NoSe _this() 
  {
    return NoSeHelper.narrow(
    super._this_object());
  }

  public NoSe _this(org.omg.CORBA.ORB orb) 
  {
    return NoSeHelper.narrow(
