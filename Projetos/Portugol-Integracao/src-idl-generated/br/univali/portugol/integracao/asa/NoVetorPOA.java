...
/**
* br/univali/portugol/integracao/asa/NoVetorPOA.java .
...
//==========================================================================================//
public abstract class NoVetorPOA extends org.omg.PortableServer.Servant
 implements br.univali.portugol.integracao.asa.NoVetorOperations, org.omg.CORBA.portable.InvokeHandler
{
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // br/univali/portugol/integracao/asa/NoVetor/getValores
       {
         org.omg.CORBA.Any $result[] = null;
         $result = this.getValores ();
         out = $rh.createReply();
         br.univali.portugol.integracao.asa.ValoresVetorHelper.write (out, $result);
         break;
       }
  ...
  private static String[] __ids = {
    "IDL:br/univali/portugol/integracao/asa/NoVetor:1.0", 
  ...
  public NoVetor _this() 
  {
    return NoVetorHelper.narrow(
    super._this_object());
  }

  public NoVetor _this(org.omg.CORBA.ORB orb) 
  {
    return NoVetorHelper.narrow(
